...
5-6-11-12\[Rule] Degradation*)pF=Compile[{{h,_Real},{kAB,_Real},{kgA,_Real},{\[Gamma]gA,_Real},{kmA,_Real},{\[Gamma]mA,_Real},{kpA,_Real},{\[Gamma]pA,_Real},{kgB,_Real},{\[Gamma]gB,_Real},{kmB,_Real},{\[Gamma]mB,_Real},{kpB,_Real},{\[Gamma]pB,_Real},{mRNAA,_Integer},{proteinA,_Integer},{mRNAB,_Integer},{proteinB,_Integer},{d0A,_Integer},{d1A,_Integer},{d0B,_Integer},{d1B,_Integer}},{d0A*kgA,d1A*\[Gamma]gA,d1A*kmA+0.01,kpA*mRNAA,mRNAA*\[Gamma]mA,\[Gamma]pA*proteinA,d0B*kgB(proteinA^h/(kAB+proteinA ^h)),d1B*\[Gamma]gB,d1B*kmB+0.01,kpB*mRNAB,mRNAB*\[Gamma]mB,\[Gamma]pB*proteinB},RuntimeAttributes->{Listable},Parallelization->True];
...
replicas2];
    ...
    Export["controlActGA_Asample\[CapitalDelta]A_"<>ToString[sample]<>","<>ToString[para]<>".csv",listEstimatesReplicatesA];
    Export["controlActGA_Bsample\[CapitalDelta]A_"<>ToString[sample]<>","<>ToString[para]<>".csv",listEstimatesReplicatesB];
    ,
