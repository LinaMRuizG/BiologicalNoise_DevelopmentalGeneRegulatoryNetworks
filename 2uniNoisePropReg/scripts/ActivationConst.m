...
pF=Compile[{{h,_Real},{kAB,_Real},{kmA,_Real},{\[Gamma]mA,_Real},{kpA,_Real},{\[Gamma]pA,_Real},{kmB,_Real},{\[Gamma]mB,_Real},{kpB,_Real},{\[Gamma]pB,_Real},{mRNAA,_Integer},{proteinA,_Integer},{mRNAB,_Integer},{proteinB,_Integer}},{kmA+0.01,kpA*mRNAA,mRNAA*\[Gamma]mA,\[Gamma]pA*proteinA,kmB*(proteinA^h/(kAB+proteinA ^h))+0.01,kpB*mRNAB,mRNAB*\[Gamma]mB,\[Gamma]pB*proteinB},RuntimeAttributes->{Listable},Parallelization->True];
...
DistributeDefinitions[changesByRXN,pF,ff,expressionNoise,iteraciones,h,kAB,kmA,\[Gamma]mA,kpA,\[Gamma]pA,kmB,\[Gamma]mB,kpB,\[Gamma]pB];
...
t=0;
abundancia={1,1,1,1}(*mRNAA,proteinA,mRNAI,proteinI,da0A,da1A,db0I,db1I*);
...
Export["controlABGAActivaConst_"<>parametros<>".csv",{listEstimatemRNAA,listEstimateproteinA,listEstimatemRNAI,listEstimateproteinI}];
...
(* ::Input::Initialization:: *)
Export["controlABGAActivaConstReg.pdf",s];
