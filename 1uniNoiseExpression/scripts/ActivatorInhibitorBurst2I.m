...
replicas1
  ...
  Export["controlAIGA_Asample\[CapitalDelta]I_"<>ToString[sample]<>","<>ToString[para]<>".csv",listEstimatesReplicatesA];
  Export["controlAIGA_Isample\[CapitalDelta]I_"<>ToString[sample]<>","<>ToString[para]<>".csv",listEstimatesReplicatesI];
,
